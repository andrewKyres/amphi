...
impl VM {
    ...
    pub fn run(&mut self) {
        loop {
            // If our program coutner has exceeded the length of the program itself, something has
            // gone awry
    ...
    /// Attempts to decode the byte the VM's program coutner is pointing at into an opcode
